...
// parseUnsubToken }). Owns no tables — writes to actions.js's action_opens /
// action_clicks / action_suppressions / action_short_links.

function mount(app, { sql, now, saveResults, parseUnsubToken }) {
