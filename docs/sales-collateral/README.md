...
| `Pulse-Sales-Pitch-Lite.pdf` | 3-page outcome-led version for first meetings and forwardable use: no feature mechanics, no competitor table, no channel/architecture detail. Share this one by default; keep the 7-pager for late-stage deep dives. |
