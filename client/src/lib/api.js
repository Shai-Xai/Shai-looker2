...
export const api = {
  ...
  journeyRecipes: (entityId) => fetch(`/api/actions/${entityId}/journey-recipes`).then(json),
  draftJourney: (entityId, b) => fetch(`/api/actions/${entityId}/draft-journey`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(b) }).then(json),
