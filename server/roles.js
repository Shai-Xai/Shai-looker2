...
const ROLES = [
  ...
  },
  {
    ...
    permissions: [P.DASHBOARDS_VIEW, P.CAMPAIGNS_VIEW, P.CAMPAIGNS_APPROVE, P.GOALS_MANAGE, P.ALERTS_MANAGE, P.DIGESTS_MANAGE, P.REPORTS_MANAGE, P.SETTLEMENTS_VIEW, P.EVENTOPS_MANAGE, P.MODERATION_MANAGE, P.MAP_MANAGE],
  },
  {
    ...
    permissions: [P.DASHBOARDS_VIEW, P.CAMPAIGNS_VIEW, P.CAMPAIGNS_APPROVE, P.GOALS_MANAGE, P.ALERTS_MANAGE, P.DIGESTS_MANAGE, P.REPORTS_MANAGE, P.MAP_MANAGE],
  },
  {
