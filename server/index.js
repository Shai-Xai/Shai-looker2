...
require('./helpBotSeed').applySeed(db, require('./helpBot').mount(app, { db, auth, insights, adminAnthropicKey, anthropicKeyForEntity, rateLimit })); // In-app help chatbot (role/tenant/event aware, retrieval-grounded) → server/helpBot.js; kill switch help_enabled
