...
const DEFAULTS = {
  ...
  aiLanguage: '',                            // language the AI WRITES generated copy in (ISO code, blank → English). Briefings/digests/insights/campaign copy + the Owl. NOT a UI translation.
  loginBackground: '',                       // image URL/data-URL for the white-label vanity login page (/<slug>); app-only, never used in emails.
};
