...
function promptRegistry() {
  return [
    ...
    { key: 'designEmail', label: 'Email layout designer', scope: 'The Owl designs a full themed block email (theme + content blocks) from a goal', text: require('./emailDesign').DESIGN_EMAIL_SYSTEM }, ...require('./journeys').promptRegistry(),
