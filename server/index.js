...
osApi = os;
require('./owlChat').mount(app, { db, auth, insights, owlTools: require('./owlTools')({ query, auth, db, getGoalsApi: () => goalsApi, resolveTileValue, getExploreFields: (m, v) => getExploreFieldsCached(m, v) }), anthropicKeyForSuite, anthropicKeyForEntity }); // agentic Owl (disposable; askData rides the scope gate)
// ─── Health ───────────────────────────────────────────────────────────────────
