#!/usr/bin/env bash
# Build script for the Milk & Cookies board deck, version 4.
# Renders pulse-pitch-mc-v4.src.html -> Pulse-Sales-Pitch-mc-v4.pdf
...
SRC="pulse-pitch-mc-v4.src.html"
OUT="Pulse-Sales-Pitch-mc-v4.pdf"
