...
function promptRegistry() {
  return [
    ...
    { key: 'helpBot', label: 'Help bot (in-app product help)', scope: 'The in-app Pulse help chatbot: retrieval-grounded answers about the product itself (how-to / what\'s new / what you can do), tailored to the user\'s role, tenant and event — declines when the answer isn\'t in the curated knowledge', text: require('./helpBot').HELP_SYSTEM },
  ];
}
