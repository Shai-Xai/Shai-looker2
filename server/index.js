...
osApi = os;
require('./owlChat').mount(app, { db, auth, insights, owlTools: require('./owlTools')({ query, auth }), anthropicKeyForSuite, anthropicKeyForEntity }); // agentic Owl (disposable; askData rides the scope gate)
// ─── Health ───────────────────────────────────────────────────────────────────
