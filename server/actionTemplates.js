...
// nodes that branch on behaviour (bought / clicked / opened / no response). The
// linear drip today runs the opening sequence; full branch execution is the J3
// engine. Same node shape the AI drafter emits + the wizard renders as a tree.
